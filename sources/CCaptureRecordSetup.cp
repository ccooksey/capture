...
/*======================================================================================*/
CCaptureRecordSetup *CCaptureRecordSetup::CreateFromStream( LStream *inStream ) {

	return( new CCaptureRecordSetup( inStream ) );
	}

/*======================================================================================*/
CCaptureRecordSetup::CCaptureRecordSetup( LStream *inStream ) :
	LWindow( inStream ) {
	}

/*======================================================================================*/
CCaptureRecordSetup::~CCaptureRecordSetup( void ) {
	}

/*======================================================================================*/
void CCaptureRecordSetup::FinishCreateSelf( void ) {
/* Fill in the blanks, start listening.													*/
	...
	ThrowIf_( mPathEditText == NULL || mChoosePathButton == NULL ||
		mNameEditText == NULL || mOKButton == NULL || mCancelButton == NULL );
...
/*======================================================================================*/
void CCaptureRecordSetup::fGetPreferenceAutomatic( SInt32 *automatic ) {
...
/*======================================================================================*/
void CCaptureRecordSetup::fSetPreferenceAutomatic( SInt32 automatic ) {

	gPreferences.fSetPreference( kPrefTagRecord, kPrefRecordAuto, automatic );
	}

/*======================================================================================*/
void CCaptureRecordSetup::fGetPreferencesDestination( char *path, char *name ) {
	...
	::GetIndString( (StringPtr)name, kStrings, kStringsRecording );
	length = name[0];
...
/*======================================================================================*/
void CCaptureRecordSetup::ListenToMessage( MessageT inMessage, void *ioParam ) {
